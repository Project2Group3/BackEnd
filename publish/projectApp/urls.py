...
from . import views
from .views import get_users, create_user, user_detail,get_items, create_item, item_detail, get_user_item_list, create_user_item_list, user_item_list_detail,create_entry, get_items_by_list_id, entry_detail, get_lists_by_user_id 
urlpatterns = [
    path('', views.homepage),
